...
class OPCUAClient:
    def __init__(self, endpoint="opc.tcp://localhost:4840/freeopcua/server/", namespace="http://example.org/fleetglue"):
    ...
    try:
        ...
        while True:
            ...
            if choice == '0':
                ...
                device_name = input("Enter device name: (default: VirtualSwitch): ") or "VirtualSwitch"
